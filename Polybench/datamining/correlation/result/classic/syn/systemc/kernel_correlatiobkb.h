...
#ifndef __kernel_correlatiobkb__HH__
#define __kernel_correlatiobkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiobkb) {
    ...
    SC_CTOR(kernel_correlatiobkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
