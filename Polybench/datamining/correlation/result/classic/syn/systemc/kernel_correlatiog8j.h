...
#ifndef __kernel_correlatiog8j__HH__
#define __kernel_correlatiog8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiog8j) {
    ...
    SC_CTOR(kernel_correlatiog8j):  simcore_mac_0_U ("simcore_mac_0_U") {
