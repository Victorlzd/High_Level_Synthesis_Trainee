...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/Polybench/datamining/correlation/result/classic/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kernel_correlation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kernel_correlation.tcl -notrace
