...
#ifndef __kernel_correlatiojbC__HH__
#define __kernel_correlatiojbC__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiojbC) {
    ...
    SC_CTOR(kernel_correlatiojbC):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
