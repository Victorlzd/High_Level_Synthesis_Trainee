...
#ifndef __kernel_correlatiokbM__HH__
#define __kernel_correlatiokbM__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiokbM) {
    ...
    SC_CTOR(kernel_correlatiokbM):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
