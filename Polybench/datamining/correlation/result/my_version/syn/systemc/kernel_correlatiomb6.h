...
#ifndef __kernel_correlatiomb6__HH__
#define __kernel_correlatiomb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiomb6) {
    ...
    SC_CTOR(kernel_correlatiomb6):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
