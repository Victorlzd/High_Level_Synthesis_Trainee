...
#ifndef __kernel_correlatioibs__HH__
#define __kernel_correlatioibs__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatioibs) {
    ...
    SC_CTOR(kernel_correlatioibs):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
