...
#ifndef __kernel_correlatiorcU__HH__
#define __kernel_correlatiorcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiorcU) {
    ...
    SC_CTOR(kernel_correlatiorcU):  simcore_mac_0_U ("simcore_mac_0_U") {
