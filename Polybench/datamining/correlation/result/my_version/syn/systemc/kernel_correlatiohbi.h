...
#ifndef __kernel_correlatiohbi__HH__
#define __kernel_correlatiohbi__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiohbi) {
    ...
    SC_CTOR(kernel_correlatiohbi):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
