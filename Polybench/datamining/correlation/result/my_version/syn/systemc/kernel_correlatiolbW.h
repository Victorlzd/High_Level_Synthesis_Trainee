...
#ifndef __kernel_correlatiolbW__HH__
#define __kernel_correlatiolbW__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_correlatiolbW) {
    ...
    SC_CTOR(kernel_correlatiolbW):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
