...
architecture behav of lut_mul3_chunk is 
    ...
    component lut_mul3_chunk_q01 IS
    generic (
        DataWidth : INTEGER;
    ...
    component lut_mul3_chunk_q12 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component lut_mul3_chunk_q23 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    q01_U : component lut_mul3_chunk_q01
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    q12_U : component lut_mul3_chunk_q12
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    q23_U : component lut_mul3_chunk_q23
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    p_Result_s_fu_146_p9 <= (((((((q7_q0 & q6_q0) & q5_q0) & q4_q0) & q3_q0) & q23_q0) & q12_q0) & q01_q0);
    q01_address0 <= tmp_fu_134_p1(6 - 1 downto 0);
    ...
    q12_address0 <= tmp_fu_134_p1(6 - 1 downto 0);
    ...
    q23_address0 <= tmp_fu_134_p1(6 - 1 downto 0);
