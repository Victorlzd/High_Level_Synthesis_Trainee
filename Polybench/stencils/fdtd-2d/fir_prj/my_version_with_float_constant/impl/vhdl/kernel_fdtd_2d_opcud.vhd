...
entity kernel_fdtd_2d_opcud is
    generic (
      ...
      din0_WIDTH : INTEGER := 57;  --data bitwidth
      din1_WIDTH : INTEGER := 57;    --shift control bitwidth
      dout_WIDTH : INTEGER := 57;  --output bitwidth
...
end entity kernel_fdtd_2d_opcud;
architecture rtl of kernel_fdtd_2d_opcud is
