...
entity lut_mul7_chunk_q01_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of lut_mul7_chunk_q01_rom is 
...
architecture arch of lut_mul7_chunk_q01 is
    component lut_mul7_chunk_q01_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    lut_mul7_chunk_q01_rom_U :  component lut_mul7_chunk_q01_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
