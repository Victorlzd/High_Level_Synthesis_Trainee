...
#ifndef __kernel_fdtd_2d_opeOg_H__
#define __kernel_fdtd_2d_opeOg_H__
...
struct kernel_fdtd_2d_opeOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(kernel_fdtd_2d_opeOg_ram) {
...
SC_MODULE(kernel_fdtd_2d_opeOg) {
...
kernel_fdtd_2d_opeOg_ram* meminst;


SC_CTOR(kernel_fdtd_2d_opeOg) {
meminst = new kernel_fdtd_2d_opeOg_ram("kernel_fdtd_2d_opeOg_ram");
