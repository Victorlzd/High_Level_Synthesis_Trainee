...
#ifndef __kernel_fdtd_2d_ophbi__HH__
#define __kernel_fdtd_2d_ophbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fdtd_2d_ophbi) {
    ...
    SC_CTOR(kernel_fdtd_2d_ophbi):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
