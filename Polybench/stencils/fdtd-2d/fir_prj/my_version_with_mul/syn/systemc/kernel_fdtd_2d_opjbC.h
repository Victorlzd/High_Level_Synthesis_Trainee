...
#ifndef __kernel_fdtd_2d_opjbC__HH__
#define __kernel_fdtd_2d_opjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fdtd_2d_opjbC) {
    ...
    SC_CTOR(kernel_fdtd_2d_opjbC):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
