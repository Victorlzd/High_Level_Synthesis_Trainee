...
entity kernel_fdtd_2d_opdEe is
    generic (
      ...
      din0_WIDTH : INTEGER := 52;  --data bitwidth
      din1_WIDTH : INTEGER := 52;    --shift control bitwidth
      dout_WIDTH : INTEGER := 52;  --output bitwidth
...
end entity kernel_fdtd_2d_opdEe;
architecture rtl of kernel_fdtd_2d_opdEe is
