set C_TypeInfoList {{ 
"kernel_fdtd_2d" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"tmax": [[], {"scalar": "int"}] }, {"nx": [[], {"scalar": "int"}] }, {"ny": [[], {"scalar": "int"}] }, {"ex": [[], {"array": [ {"array": [ {"scalar": "double"}, [1000]]}, [1000]]}] }, {"ey": [[], {"array": [ {"array": [ {"scalar": "double"}, [1000]]}, [1000]]}] }, {"hz": [[], {"array": [ {"array": [ {"scalar": "double"}, [1000]]}, [1000]]}] }, {"_fict_": [[], {"array": [ {"scalar": "double"}, [50]]}] }],[],""]
}}
set moduleName kernel_fdtd_2d
...
set C_modelName {kernel_fdtd_2d}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3245651601", "EstimateLatencyMax" : "3245651601",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_fdtd_2d_dabkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_fdtd_2d_dmcud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_fdtd_2d_mudEe_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_fdtd_2d_mudEe_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel_fdtd_2d_mudEe_U5", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3245651601", "Max" : "3245651601"}
	, {"Name" : "Interval", "Min" : "-1049315694", "Max" : "-1049315694"}
]}
