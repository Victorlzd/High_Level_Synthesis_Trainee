...
#ifndef __kernel_jacobi_1d_dEe__HH__
#define __kernel_jacobi_1d_dEe__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_jacobi_1d_dEe) {
    ...
    SC_CTOR(kernel_jacobi_1d_dEe):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
