...
begin
    ...
    kernel_jacobi_1d_bkb_U2 : component kernel_jacobi_1d_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    kernel_jacobi_1d_bkb_U3 : component kernel_jacobi_1d_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    kernel_jacobi_1d_bkb_U4 : component kernel_jacobi_1d_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    kernel_jacobi_1d_bkb_U5 : component kernel_jacobi_1d_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    kernel_jacobi_1d_bkb_U6 : component kernel_jacobi_1d_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
