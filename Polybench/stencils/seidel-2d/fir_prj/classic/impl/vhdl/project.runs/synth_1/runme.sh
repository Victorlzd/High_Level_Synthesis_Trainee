...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/Polybench/stencils/seidel-2d/fir_prj/classic/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kernel_seidel_2d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kernel_seidel_2d.tcl
