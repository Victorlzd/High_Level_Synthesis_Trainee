...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("A_address0", 20, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("A_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("A_q0", 64, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("A_address1", 20, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("A_ce1", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("A_we1", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("A_d1", 64, hls_out, 2, "ap_memory", "mem_din", 1),
	Port_Property("A_q1", 64, hls_in, 2, "ap_memory", "mem_dout", 1),
};
const char* HLS_Design_Meta::dut_name = "kernel_seidel_2d";
