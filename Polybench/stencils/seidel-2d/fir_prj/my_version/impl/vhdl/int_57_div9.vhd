...
architecture behav of int_57_div9 is 
    ...
    signal tmp_26_fu_461_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_26_reg_644 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_lut_div9_chunk_fu_142_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                tmp_26_reg_644 <= tmp_26_fu_461_p1;
            end if;
        end if;
    end process;
