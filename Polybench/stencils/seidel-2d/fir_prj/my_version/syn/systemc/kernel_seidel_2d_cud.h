...
#ifndef __kernel_seidel_2d_cud__HH__
#define __kernel_seidel_2d_cud__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_seidel_2d_cud) {
    ...
    SC_CTOR(kernel_seidel_2d_cud):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
