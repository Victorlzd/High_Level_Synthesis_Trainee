...
#ifndef __kernel_jacobi_2d_eOg__HH__
#define __kernel_jacobi_2d_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_jacobi_2d_eOg) {
    ...
    SC_CTOR(kernel_jacobi_2d_eOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
