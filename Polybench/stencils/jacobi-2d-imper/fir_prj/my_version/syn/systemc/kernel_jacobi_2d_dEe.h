...
#ifndef __kernel_jacobi_2d_dEe__HH__
#define __kernel_jacobi_2d_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_jacobi_2d_dEe) {
    ...
    SC_CTOR(kernel_jacobi_2d_dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
