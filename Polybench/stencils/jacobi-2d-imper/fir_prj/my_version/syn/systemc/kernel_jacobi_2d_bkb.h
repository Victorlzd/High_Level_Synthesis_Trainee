...
#ifndef __kernel_jacobi_2d_bkb__HH__
#define __kernel_jacobi_2d_bkb__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_jacobi_2d_bkb) {
    ...
    SC_CTOR(kernel_jacobi_2d_bkb):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
