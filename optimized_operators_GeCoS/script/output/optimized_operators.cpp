...
ap_uint<1> lut_r0_div23(ap_uint<1> d, ap_uint<5> r_in);
ap_uint<1> lut_r1_div23(ap_uint<1> d, ap_uint<5> r_in);
ap_uint<1> lut_r2_div23(ap_uint<1> d, ap_uint<5> r_in);
ap_uint<1> lut_r3_div23(ap_uint<1> d, ap_uint<5> r_in);
ap_uint<1> lut_r4_div23(ap_uint<1> d, ap_uint<5> r_in);
ap_uint<1> lut_q0_div23(ap_uint<1> d, ap_uint<5> r_in);
void lut_div23_chunk(ap_uint<1> d, ap_uint<5> r_in, ap_uint<1> (* q), ap_uint<5> (* r_out));
/* int_32_div23 implements a division by 23 of the integer 32 bits in, optimized for Vivado HLS */
ap_uint<32> int_32_div23(ap_uint<32> in);
/* operator_int_32_div69 implements a division by 69 of the integer 32 bits in, optimized for Vivado HLS */
ap_uint<32> operator_int_32_div69(ap_uint<32> in);
...
void lut_div23_chunk(ap_uint<1> d, ap_uint<5> r_in, ap_uint<1> (* q), ap_uint<5> (* r_out)) {
	(*r_out)[0] = lut_r0_div23(d, r_in);
	(*r_out)[1] = lut_r1_div23(d, r_in);
	(*r_out)[2] = lut_r2_div23(d, r_in);
	(*r_out)[3] = lut_r3_div23(d, r_in);
	(*r_out)[4] = lut_r4_div23(d, r_in);
	(*q)[0] = lut_q0_div23(d, r_in);
}
...
ap_uint<32> int_32_div23(ap_uint<32> in) {
	...
	for(i = 31; i >= 0; i = i - 1) {
		...
		{
		d_chunk = d.range(i*1 + 0, i*1);
		lut_div23_chunk(d_chunk, r, &q_chunk, &r);
		q.range(i*1 + 0, i*1) = q_chunk;
		}
	}
	return q;
...
ap_uint<32> operator_int_32_div69(ap_uint<32> in) {
	return int_32_div23(int_32_div3(in));
}
