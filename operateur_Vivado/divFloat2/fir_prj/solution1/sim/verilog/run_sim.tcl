...
if {[file isfile float_div2.autotvin.dat]} {
	file delete -force float_div2.autotvin.dat
}

if {[file isfile float_div2.autotvout.dat]} {
	file delete -force float_div2.autotvout.dat
}
