...
HD_PWD='/home/duazel/Documents/stage3IF/operateur_Vivado/divFloat2/fir_prj/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_div2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_div2.tcl
