...
HD_PWD='/home/duazel/Documents/stage3IF/operateur_Vivado/divFloat2/fir_prj/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log float_div2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source float_div2.tcl -notrace
