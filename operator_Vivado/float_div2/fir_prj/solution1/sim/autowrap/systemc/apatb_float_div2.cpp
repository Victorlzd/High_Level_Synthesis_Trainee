...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.float_div2.autotvout_ap_return.dat"
...
extern float float_div2 (
float in);

float AESL_WRAP_float_div2 (
float in)
{
...
// [call_c_dut] ---------->
		...
		float AESL_return = float_div2(in);
