...
#include "div7_mul_64s_66nsbkb.h"

namespace ap_rtl {

struct div7 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    div7_mul_64s_66nsbkb<1,2,64,66,129>* div7_mul_64s_66nsbkb_U1;
    ...
    static const sc_lv<129> ap_const_lv129_lc_4;
