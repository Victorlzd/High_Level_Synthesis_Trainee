...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/vivado_hls_long_div/div9/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div9.tcl
