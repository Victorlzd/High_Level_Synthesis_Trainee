...
#include "div10_mul_64s_66nbkb.h"

namespace ap_rtl {

struct div10 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    div10(sc_module_name name);
    SC_HAS_PROCESS(div10);
    ...
    div10_mul_64s_66nbkb<1,2,64,66,129>* div10_mul_64s_66nbkb_U1;
