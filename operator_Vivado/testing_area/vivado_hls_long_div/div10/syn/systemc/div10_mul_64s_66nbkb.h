...
#ifndef __div10_mul_64s_66nbkb__HH__
#define __div10_mul_64s_66nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(div10_mul_64s_66nbkb) {
    ...
    SC_CTOR(div10_mul_64s_66nbkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
