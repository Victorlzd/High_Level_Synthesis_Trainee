...
#include "div11_mul_64s_66nbkb.h"

namespace ap_rtl {

struct div11 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    div11(sc_module_name name);
    SC_HAS_PROCESS(div11);
    ...
    div11_mul_64s_66nbkb<1,2,64,66,129>* div11_mul_64s_66nbkb_U1;
    ...
    sc_signal< sc_lv<61> > tmp_5_fu_64_p4;
    sc_signal< sc_lv<61> > tmp_6_fu_78_p4;
    ...
    static const sc_lv<129> ap_const_lv129_lc_6;
