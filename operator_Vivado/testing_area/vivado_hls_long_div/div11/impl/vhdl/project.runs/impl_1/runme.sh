...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/vivado_hls_long_div/div11/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source div11.tcl -notrace
