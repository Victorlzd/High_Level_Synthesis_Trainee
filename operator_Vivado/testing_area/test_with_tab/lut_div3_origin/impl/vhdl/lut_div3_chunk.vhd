...
architecture behav of lut_div3_chunk is 
    ...
    "lut_div3_chunk,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=12.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.958000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=1638,HLS_VERSION=2018_2}";
    ...
    signal p_Result_8_fu_60_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal agg_result_V_i7_fu_202_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i_fu_68_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i3_fu_747_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i2_fu_613_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i1_fu_479_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i9_fu_345_p66 : STD_LOGIC_VECTOR (0 downto 0);

    component lut_div3_chunk_mubkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    lut_div3_chunk_mubkb_U1 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    lut_div3_chunk_mubkb_U2 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    lut_div3_chunk_mubkb_U3 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    lut_div3_chunk_mubkb_U4 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    lut_div3_chunk_mubkb_U5 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    lut_div3_chunk_mubkb_U6 : component lut_div3_chunk_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    ap_ready <= ap_start;
    p_Result_8_fu_60_p3 <= (r_in_V & d_V);
    q_V <= (((agg_result_V_i3_fu_747_p66 & agg_result_V_i2_fu_613_p66) & agg_result_V_i1_fu_479_p66) & agg_result_V_i9_fu_345_p66);

    q_V_ap_vld_assign_proc : process(ap_start)
    begin
    ...
    r_out_V <= (agg_result_V_i7_fu_202_p66 & agg_result_V_i_fu_68_p66);

    r_out_V_ap_vld_assign_proc : process(ap_start)
    begin
        if ((ap_start = ap_const_logic_1)) then 
