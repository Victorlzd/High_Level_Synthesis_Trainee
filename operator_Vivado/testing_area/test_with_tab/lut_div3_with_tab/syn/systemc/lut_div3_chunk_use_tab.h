...
#ifndef _lut_div3_chunk_use_tab_HH_
#define _lut_div3_chunk_use_tab_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "lut_div3_chunk_usbkb.h"
#include "lut_div3_chunk_uscud.h"
#include "lut_div3_chunk_usdEe.h"
#include "lut_div3_chunk_useOg.h"
#include "lut_div3_chunk_usfYi.h"
#include "lut_div3_chunk_usg8j.h"

namespace ap_rtl {

struct lut_div3_chunk_use_tab : public sc_module {
    ...
    // Module declarations
    lut_div3_chunk_use_tab(sc_module_name name);
    SC_HAS_PROCESS(lut_div3_chunk_use_tab);
    ...
    lut_div3_chunk_usbkb* r0_U;
    lut_div3_chunk_uscud* r1_U;
    lut_div3_chunk_usdEe* q0_U;
    lut_div3_chunk_useOg* q1_U;
    lut_div3_chunk_usfYi* q2_U;
    lut_div3_chunk_usg8j* q3_U;
