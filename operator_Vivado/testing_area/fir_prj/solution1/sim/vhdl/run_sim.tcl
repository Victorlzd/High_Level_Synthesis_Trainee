...
if {[file isfile operator_int_32_div30.autotvin.dat]} {
	file delete -force operator_int_32_div30.autotvin.dat
}

if {[file isfile operator_int_32_div30.autotvout.dat]} {
	file delete -force operator_int_32_div30.autotvout.dat
}
