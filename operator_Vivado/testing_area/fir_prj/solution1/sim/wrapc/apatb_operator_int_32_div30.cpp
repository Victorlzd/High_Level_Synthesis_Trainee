...
#define AUTOTB_TVIN_in_V  "../tv/cdatafile/c.operator_int_32_div30.autotvin_in_V.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.operator_int_32_div30.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.operator_int_32_div30.autotvout_ap_return.dat"
...
extern ap_uint<32> operator_int_32_div30 (
ap_uint<32> in);

ap_uint<32> AESL_WRAP_operator_int_32_div30 (
ap_uint<32> in)
{
	...
	else
	{
		...
		sc_bv<32> in_V_tvin_wrapc_buffer;
				...
				// celement: in.V(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						if (&(in) != NULL) // check the null address if the c port is array or others
						{
							...
							in_V_tvin_wrapc_buffer.range(31, 0) = in_V_tmp_mem.range(31, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		ap_uint<32> AESL_return = operator_int_32_div30(in);
