...
architecture behav of div3 is 
    ...
    "div3,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.519000,HLS_SYN_LAT=29,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1466,HLS_SYN_LUT=997,HLS_VERSION=2018_2}";
    ...
    component div3_fdiv_32ns_32bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    div3_fdiv_32ns_32bkb_U1 : component div3_fdiv_32ns_32bkb
    generic map (
        ID => 1,
        NUM_STAGE => 30,
        din0_WIDTH => 32,
