...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/int_mul/mul11/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_int_mul11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operator_int_mul11.tcl -notrace
