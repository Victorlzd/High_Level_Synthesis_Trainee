...
lut_mul3_chunk::lut_mul3_chunk(sc_module_name name) : sc_module(name), mVcdFile(0) {
    q0_U = new lut_mul3_chunk_q0("q0_U");
    q0_U->clk(ap_clk);
    q0_U->reset(ap_rst);
    q0_U->address0(q0_address0);
    q0_U->ce0(q0_ce0);
    q0_U->q0(q0_q0);
    q1_U = new lut_mul3_chunk_q1("q1_U");
    q1_U->clk(ap_clk);
    q1_U->reset(ap_rst);
    q1_U->address0(q1_address0);
    q1_U->ce0(q1_ce0);
    q1_U->q0(q1_q0);
    q2_U = new lut_mul3_chunk_q2("q2_U");
    q2_U->clk(ap_clk);
    q2_U->reset(ap_rst);
...
void lut_mul3_chunk::thread_p_Result_s_fu_146_p9() {
    p_Result_s_fu_146_p9 = esl_concat<7,1>(esl_concat<6,1>(esl_concat<5,1>(esl_concat<4,1>(esl_concat<3,1>(esl_concat<2,1>(esl_concat<1,1>(q7_q0.read(), q6_q0.read()), q5_q0.read()), q4_q0.read()), q3_q0.read()), q2_q0.read()), q1_q0.read()), q0_q0.read());
}

void lut_mul3_chunk::thread_q0_address0() {
    q0_address0 =  (sc_lv<6>) (tmp_fu_134_p1.read());
}

void lut_mul3_chunk::thread_q0_ce0() {
...
void lut_mul3_chunk::thread_q1_address0() {
    q1_address0 =  (sc_lv<6>) (tmp_fu_134_p1.read());
}

void lut_mul3_chunk::thread_q1_ce0() {
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void lut_mul3_chunk::thread_q2_address0() {
    q2_address0 =  (sc_lv<6>) (tmp_fu_134_p1.read());
}

void lut_mul3_chunk::thread_q2_ce0() {
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
