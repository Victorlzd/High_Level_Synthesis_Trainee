...
entity lut_mul3_chunk_q0_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of lut_mul3_chunk_q0_rom is 
...
architecture arch of lut_mul3_chunk_q0 is
    component lut_mul3_chunk_q0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    lut_mul3_chunk_q0_rom_U :  component lut_mul3_chunk_q0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
