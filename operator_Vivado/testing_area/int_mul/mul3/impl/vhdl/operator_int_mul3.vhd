...
architecture behav of operator_int_mul3 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "operator_int_mul3,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.785000,HLS_SYN_LAT=8,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=241,HLS_SYN_LUT=349,HLS_VERSION=2018_2}";
    ...
    signal tmp_1_fu_172_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_1_reg_313 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_i_reg_318 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_1_i_reg_323 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_2_i_reg_328 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_3_i_reg_333 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_4_i_fu_218_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal p_Result_4_i_reg_338 : STD_LOGIC_VECTOR (1 downto 0);
    signal this_assign_5_i_fu_228_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal this_assign_5_i_reg_343 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_lut_mul3_chunk_fu_122_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    signal chunk_24_29_V_reg_348 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp1_fu_256_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp1_reg_353 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_2_fu_262_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_2_reg_358 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_fu_285_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal tmp_reg_363 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp2_fu_299_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp2_reg_368 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_lut_mul3_chunk_fu_80_ap_start : STD_LOGIC;
    signal grp_lut_mul3_chunk_fu_80_d_V : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_lut_mul3_chunk_fu_101_ap_start : STD_LOGIC;
    signal grp_lut_mul3_chunk_fu_101_d_V : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal r_V_1_fu_232_p3 : STD_LOGIC_VECTOR (19 downto 0);
    signal r_V_2_fu_244_p3 : STD_LOGIC_VECTOR (25 downto 0);
    signal r_V_2_cast_fu_252_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal r_V_1_cast_fu_240_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal r_V_fu_266_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal r_V_cast_fu_274_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal r_V_3_fu_278_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp3_fu_290_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_cast_fu_305_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state3_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                chunk_24_29_V_reg_348 <= grp_lut_mul3_chunk_fu_122_ap_return;
                    tmp1_reg_353(26 downto 12) <= tmp1_fu_256_p2(26 downto 12);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                p_Result_1_i_reg_323 <= in_r(17 downto 12);
                p_Result_2_i_reg_328 <= in_r(23 downto 18);
                p_Result_3_i_reg_333 <= in_r(29 downto 24);
                p_Result_4_i_reg_338 <= p_Result_4_i_fu_218_p4;
                p_Result_i_reg_318 <= in_r(11 downto 6);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    this_assign_5_i_reg_343(1 downto 0) <= this_assign_5_i_fu_228_p1(1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp2_reg_368 <= tmp2_fu_299_p2;
                    tmp_reg_363(26 downto 6) <= tmp_fu_285_p2(26 downto 6);
            end if;
        end if;
    end process;
    this_assign_5_i_reg_343(5 downto 2) <= "0000";
    tmp1_reg_353(11 downto 0) <= "000000000000";
    tmp_reg_363(5 downto 0) <= "000000";
    ...
    ap_block_state2_on_subcall_done_assign_proc : process(grp_lut_mul3_chunk_fu_80_ap_done, grp_lut_mul3_chunk_fu_101_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((grp_lut_mul3_chunk_fu_101_ap_done = ap_const_logic_0) or (grp_lut_mul3_chunk_fu_80_ap_done = ap_const_logic_0));
    end process;


    ap_block_state3_on_subcall_done_assign_proc : process(grp_lut_mul3_chunk_fu_80_ap_done, grp_lut_mul3_chunk_fu_101_ap_done, grp_lut_mul3_chunk_fu_122_ap_done, grp_lut_mul3_chunk_fu_143_ap_done)
    begin
                ap_block_state3_on_subcall_done <= ((grp_lut_mul3_chunk_fu_143_ap_done = ap_const_logic_0) or (grp_lut_mul3_chunk_fu_122_ap_done = ap_const_logic_0) or (grp_lut_mul3_chunk_fu_101_ap_done = ap_const_logic_0) or (grp_lut_mul3_chunk_fu_80_ap_done = ap_const_logic_0));
    end process;
    ...
    ap_return <= std_logic_vector(unsigned(tmp_cast_fu_305_p1) + unsigned(tmp2_reg_368));
    grp_lut_mul3_chunk_fu_101_ap_start <= grp_lut_mul3_chunk_fu_101_ap_start_reg;

    grp_lut_mul3_chunk_fu_101_d_V_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state3, p_Result_i_reg_318, p_Result_2_i_reg_328)
    begin
    ...
    grp_lut_mul3_chunk_fu_80_d_V_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state3, tmp_1_reg_313, p_Result_1_i_reg_323)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    p_Result_4_i_fu_218_p4_proc : process(in_r)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable p_Result_4_i_fu_218_p4_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            ...
            for p_Result_4_i_fu_218_p4_i in 0 to 32-1 loop
                v0_cpy(p_Result_4_i_fu_218_p4_i) := in_r(32-1-p_Result_4_i_fu_218_p4_i);
            end loop;
        end if;
        ...
        p_Result_4_i_fu_218_p4 <= resvalue(2-1 downto 0);
    end process;

    r_V_1_cast_fu_240_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_V_1_fu_232_p3),27));
    r_V_1_fu_232_p3 <= (reg_164 & ap_const_lv12_0);
    r_V_2_cast_fu_252_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_V_2_fu_244_p3),27));
    r_V_2_fu_244_p3 <= (reg_168 & ap_const_lv18_0);
    r_V_3_fu_278_p3 <= (chunk_24_29_V_reg_348 & ap_const_lv24_0);
    r_V_cast_fu_274_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_V_fu_266_p3),27));
    r_V_fu_266_p3 <= (reg_168 & ap_const_lv6_0);
    this_assign_5_i_fu_228_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_4_i_reg_338),6));
    tmp1_fu_256_p2 <= std_logic_vector(unsigned(r_V_2_cast_fu_252_p1) + unsigned(r_V_1_cast_fu_240_p1));
    tmp2_fu_299_p2 <= std_logic_vector(unsigned(r_V_3_fu_278_p3) + unsigned(tmp3_fu_290_p4));
    tmp3_fu_290_p4 <= ((tmp_2_reg_358 & ap_const_lv22_0) & reg_164);
    tmp_1_fu_172_p1 <= in_r(6 - 1 downto 0);
    tmp_2_fu_262_p1 <= grp_lut_mul3_chunk_fu_143_ap_return(2 - 1 downto 0);
    tmp_cast_fu_305_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_reg_363),32));
    tmp_fu_285_p2 <= std_logic_vector(unsigned(r_V_cast_fu_274_p1) + unsigned(tmp1_reg_353));
end behav;
