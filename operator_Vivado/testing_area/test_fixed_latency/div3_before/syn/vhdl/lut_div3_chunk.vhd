...
architecture behav of lut_div3_chunk is 
    ...
    signal p_Result_1_fu_146_p5 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    ap_return_0_preg <= p_Result_1_fu_146_p5;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state2, p_Result_1_fu_146_p5, ap_return_0_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            ap_return_0 <= p_Result_1_fu_146_p5;
        else 
    ...
    p_Result_1_fu_146_p5 <= (((q3_q0 & q2_q0) & q1_q0) & q0_q0);
