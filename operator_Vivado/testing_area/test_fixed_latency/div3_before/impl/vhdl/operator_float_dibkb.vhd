...
entity operator_float_dibkb is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 24;  --data bitwidth
      din1_WIDTH : INTEGER := 24;    --shift control bitwidth
      dout_WIDTH : INTEGER := 24;  --output bitwidth
...
end entity operator_float_dibkb;
architecture rtl of operator_float_dibkb is
