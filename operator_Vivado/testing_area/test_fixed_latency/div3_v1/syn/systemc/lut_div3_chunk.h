...
struct lut_div3_chunk : public sc_module {
    ...
    sc_signal< sc_lv<4> > p_Result_2_fu_146_p5;
    sc_signal< sc_lv<2> > p_Result_s_fu_138_p3;
    sc_signal< sc_lv<4> > ap_return_0_preg;
    sc_signal< sc_lv<2> > ap_return_1_preg;
    ...
    void thread_p_Result_2_fu_146_p5();
