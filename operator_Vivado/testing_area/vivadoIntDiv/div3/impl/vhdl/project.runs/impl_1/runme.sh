...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/vivadoIntDiv/div3/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log int_div3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source int_div3.tcl -notrace
