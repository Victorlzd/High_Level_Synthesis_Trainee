...
int_div3_mul_32s_bkb #(
    .ID( 1 ),
    .NUM_STAGE( 7 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 34 ),
    .dout_WIDTH( 65 ))
int_div3_mul_32s_bkb_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(a),
    .din1(grp_fu_36_p1),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        tmp_6_reg_115 <= {{grp_fu_36_p2[64:34]}};
    end
end
...
assign grp_fu_36_p1 = 65'd5726623062;
...
assign tmp_5_fu_65_p4 = {{neg_mul_reg_120[64:34]}};
