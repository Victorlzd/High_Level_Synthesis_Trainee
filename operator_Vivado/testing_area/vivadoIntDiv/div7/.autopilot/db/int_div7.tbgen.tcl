set C_TypeInfoList {{ 
"int_div7" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"a": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName int_div7
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.int_div7_mul_32s_bkb_U1", "Parent" : "0"}]}
