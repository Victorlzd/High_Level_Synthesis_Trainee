...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/vivadoIntDiv/div7/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_div7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_div7.tcl
