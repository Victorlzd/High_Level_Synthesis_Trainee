...
struct operator_int_div7 : public sc_module {
    ...
    sc_signal< sc_logic > grp_lut_div7_chunk_fu_80_ap_idle;
    sc_signal< sc_logic > grp_lut_div7_chunk_fu_80_ap_ready;
    sc_signal< sc_logic > grp_lut_div7_chunk_fu_80_ap_done;
    ...
    sc_signal< sc_logic > grp_lut_div7_chunk_fu_80_ap_start;
    sc_signal< sc_lv<3> > grp_lut_div7_chunk_fu_80_d_V;
    sc_signal< sc_lv<3> > grp_lut_div7_chunk_fu_80_r_in_V;
    sc_signal< sc_lv<3> > grp_lut_div7_chunk_fu_80_ap_return_0;
    sc_signal< sc_lv<3> > grp_lut_div7_chunk_fu_80_ap_return_1;
    sc_signal< sc_logic > grp_lut_div7_chunk_fu_80_ap_start_reg;
    ...
    void thread_grp_lut_div7_chunk_fu_80_ap_start();
    void thread_grp_lut_div7_chunk_fu_80_d_V();
    void thread_grp_lut_div7_chunk_fu_80_r_in_V();
