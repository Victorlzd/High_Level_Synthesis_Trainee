...
struct operator_int_div5 : public sc_module {
    ...
    sc_signal< sc_logic > grp_lut_div5_chunk_fu_68_ap_ready;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_68_d_V;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_68_r_in_V;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_68_ap_return_0;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_68_ap_return_1;
    sc_signal< sc_logic > grp_lut_div5_chunk_fu_75_ap_ready;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_75_d_V;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_75_ap_return_0;
    sc_signal< sc_lv<3> > grp_lut_div5_chunk_fu_75_ap_return_1;
    ...
    sc_signal< sc_logic > call_ret4_9_i_i_lut_div5_chunk_fu_99_ap_ready;
    sc_signal< sc_lv<3> > call_ret4_9_i_i_lut_div5_chunk_fu_99_ap_return_0;
    sc_signal< sc_lv<3> > call_ret4_9_i_i_lut_div5_chunk_fu_99_ap_return_1;
    ...
    void thread_grp_lut_div5_chunk_fu_68_d_V();
    void thread_grp_lut_div5_chunk_fu_68_r_in_V();
    void thread_grp_lut_div5_chunk_fu_75_d_V();
