...
architecture behav of lut_div5_chunk is 
    ...
    component operator_int_div5bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    operator_int_div5bkb_U1 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div5bkb_U2 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div5bkb_U3 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div5bkb_U4 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div5bkb_U5 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div5bkb_U6 : component operator_int_div5bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
