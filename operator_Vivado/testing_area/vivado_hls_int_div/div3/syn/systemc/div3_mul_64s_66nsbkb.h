...
#ifndef __div3_mul_64s_66nsbkb__HH__
#define __div3_mul_64s_66nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(div3_mul_64s_66nsbkb) {
    ...
    SC_CTOR(div3_mul_64s_66nsbkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
