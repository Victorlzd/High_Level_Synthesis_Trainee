...
#ifndef __div5_mul_64s_66nsbkb__HH__
#define __div5_mul_64s_66nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(div5_mul_64s_66nsbkb) {
    ...
    SC_CTOR(div5_mul_64s_66nsbkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
