set C_TypeInfoList {{ 
"operator_double_div2" : [[], {"return": [[], {"scalar": "double"}] }, [{"ExternC" : 0}], [ {"in": [[], {"scalar": "double"}] }],[],""]
}}
set moduleName operator_double_div2
...
set C_modelName {operator_double_div2}
