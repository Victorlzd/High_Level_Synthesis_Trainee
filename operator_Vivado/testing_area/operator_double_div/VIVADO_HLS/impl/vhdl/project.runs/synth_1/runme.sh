...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/operator_double_div/VIVADO_HLS/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
