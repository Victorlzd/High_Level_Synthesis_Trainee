set C_TypeInfoList {{ 
"operator_double_div4" : [[], {"return": [[], {"scalar": "double"}] }, [{"ExternC" : 0}], [ {"in": [[], {"scalar": "double"}] }],[],""]
}}
set moduleName operator_double_div4
...
set C_modelName {operator_double_div4}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.operator_double_dcud_U2", "Parent" : "0"}]}
