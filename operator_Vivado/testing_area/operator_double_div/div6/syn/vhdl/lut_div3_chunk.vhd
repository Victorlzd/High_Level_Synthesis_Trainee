...
architecture behav of lut_div3_chunk is 
    ...
    signal p_Result_2_fu_146_p5 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_Result_s_fu_138_p3 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    ap_return_0_preg <= p_Result_2_fu_146_p5;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    ap_return_1_preg <= p_Result_s_fu_138_p3;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state2, p_Result_2_fu_146_p5, ap_return_0_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            ap_return_0 <= p_Result_2_fu_146_p5;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state2, p_Result_s_fu_138_p3, ap_return_1_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            ap_return_1 <= p_Result_s_fu_138_p3;
        else 
            ap_return_1 <= ap_return_1_preg;
        end if; 
    end process;

    p_Result_2_fu_146_p5 <= (((q3_q0 & q2_q0) & q1_q0) & q0_q0);
    p_Result_4_fu_120_p3 <= (r_in_V & d_V);
    p_Result_s_fu_138_p3 <= (r1_q0 & r0_q0);
    ...
    q2_address0 <= tmp_fu_128_p1(6 - 1 downto 0);
    ...
    q3_address0 <= tmp_fu_128_p1(6 - 1 downto 0);
