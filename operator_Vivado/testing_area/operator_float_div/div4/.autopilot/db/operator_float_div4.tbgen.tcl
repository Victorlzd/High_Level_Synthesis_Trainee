set C_TypeInfoList {{ 
"operator_float_div4" : [[], {"return": [[], {"scalar": "float"}] }, [{"ExternC" : 0}], [ {"in": [[], {"scalar": "float"}] }],[],""]
}}
set moduleName operator_float_div4
...
set C_modelName {operator_float_div4}
