...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/operator_float_div/div4/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_float_div4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operator_float_div4.tcl -notrace
