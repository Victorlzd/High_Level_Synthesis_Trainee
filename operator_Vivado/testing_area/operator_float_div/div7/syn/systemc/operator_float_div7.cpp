...
operator_float_div7::operator_float_div7(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    mHdltvinHandle.open("operator_float_div7.hdltvin.dat");
    mHdltvoutHandle.open("operator_float_div7.hdltvout.dat");
}

operator_float_div7::~operator_float_div7() {
    if (mVcdFile) 
...
void operator_float_div7::thread_ap_CS_fsm_state1() {
...
void operator_float_div7::thread_ap_idle() {
...
void operator_float_div7::thread_hdltv_gen() {
