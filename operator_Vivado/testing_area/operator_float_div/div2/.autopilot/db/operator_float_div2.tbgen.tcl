set C_TypeInfoList {{ 
"operator_float_div2" : [[], {"return": [[], {"scalar": "float"}] }, [{"ExternC" : 0}], [ {"in": [[], {"scalar": "float"}] }],[],""]
}}
set moduleName operator_float_div2
...
set C_modelName {operator_float_div2}
