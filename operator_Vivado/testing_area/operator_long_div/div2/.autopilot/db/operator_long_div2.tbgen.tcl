set C_TypeInfoList {{ 
"operator_long_div2" : [[], {"return": [[], {"scalar": "long int"}] }, [{"ExternC" : 0}], [ {"in": [[], {"scalar": "long int"}] }],[],""]
}}
set moduleName operator_long_div2
...
set C_modelName {operator_long_div2}
