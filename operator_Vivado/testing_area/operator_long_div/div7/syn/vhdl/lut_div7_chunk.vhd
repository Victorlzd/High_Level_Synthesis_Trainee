...
architecture behav of lut_div7_chunk is 
    ...
    component operator_long_divbkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    operator_long_divbkb_U1 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_long_divbkb_U2 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_long_divbkb_U3 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_long_divbkb_U4 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_long_divbkb_U5 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_long_divbkb_U6 : component operator_long_divbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
