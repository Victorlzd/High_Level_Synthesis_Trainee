...
architecture behav of lut_div9_chunk is 
    ...
    signal p_Result_3_fu_120_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal p_Result_1_fu_150_p3 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component lut_div9_chunk_r0 IS
    generic (
        DataWidth : INTEGER;
    ...
    component lut_div9_chunk_r1 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component lut_div9_chunk_r2 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component lut_div9_chunk_r3 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component lut_div9_chunk_q0 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component lut_div9_chunk_q1 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    r0_U : component lut_div9_chunk_r0
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    r1_U : component lut_div9_chunk_r1
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    r2_U : component lut_div9_chunk_r2
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    r3_U : component lut_div9_chunk_r3
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    q0_U : component lut_div9_chunk_q0
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    q1_U : component lut_div9_chunk_q1
    generic map (
        DataWidth => 1,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state2, p_Result_1_fu_150_p3, ap_return_0_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    p_Result_1_fu_150_p3 <= (q1_q0 & q0_q0);
    p_Result_3_fu_120_p3 <= (r_in_V & d_V);
    ...
    tmp_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_3_fu_120_p3),64));
end behav;
