...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/operator_long_div/div9/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_long_div9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source operator_long_div9.tcl
