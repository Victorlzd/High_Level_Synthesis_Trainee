...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/operator_long_div/div10/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_long_div10.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operator_long_div10.tcl -notrace
