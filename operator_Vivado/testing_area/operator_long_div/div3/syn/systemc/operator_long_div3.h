...
struct operator_long_div3 : public sc_module {
    ...
    sc_signal< sc_lv<2> > reg_125;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_logic > grp_lut_div3_chunk_fu_98_ap_idle;
    sc_signal< sc_logic > grp_lut_div3_chunk_fu_98_ap_ready;
    sc_signal< sc_logic > grp_lut_div3_chunk_fu_98_ap_done;
    ...
    sc_signal< sc_lv<4> > d_chunk_V_reg_306;
    sc_signal< sc_lv<4> > d_chunk_V_1_reg_311;
    sc_signal< sc_lv<4> > d_chunk_V_2_reg_316;
    sc_signal< sc_lv<4> > d_chunk_V_3_reg_321;
    sc_signal< sc_lv<4> > d_chunk_V_4_reg_326;
    sc_signal< sc_lv<4> > d_chunk_V_5_reg_331;
    sc_signal< sc_lv<4> > d_chunk_V_6_reg_336;
    sc_signal< sc_lv<4> > d_chunk_V_7_reg_341;
    sc_signal< sc_lv<4> > d_chunk_V_8_reg_346;
    sc_signal< sc_lv<4> > d_chunk_V_9_reg_351;
    sc_signal< sc_lv<4> > d_chunk_V_10_reg_356;
    sc_signal< sc_lv<4> > d_chunk_V_11_reg_361;
    sc_signal< sc_lv<4> > d_chunk_V_12_reg_366;
    sc_signal< sc_lv<4> > d_chunk_V_13_reg_371;
    sc_signal< sc_lv<4> > d_chunk_V_14_reg_376;
    sc_signal< sc_lv<4> > d_chunk_V_15_fu_281_p1;
    sc_signal< sc_lv<4> > d_chunk_V_15_reg_381;
    sc_signal< sc_lv<4> > q_chunk_V_reg_386;
    sc_signal< sc_lv<4> > q_chunk_V_1_reg_391;
    sc_signal< sc_lv<4> > q_chunk_V_2_reg_396;
    sc_signal< sc_lv<4> > q_chunk_V_3_reg_401;
    sc_signal< sc_lv<4> > q_chunk_V_4_reg_406;
    sc_signal< sc_lv<4> > q_chunk_V_5_reg_411;
    sc_signal< sc_lv<4> > q_chunk_V_6_reg_416;
    sc_signal< sc_lv<4> > q_chunk_V_7_reg_421;
    sc_signal< sc_lv<4> > q_chunk_V_8_reg_426;
    sc_signal< sc_lv<4> > q_chunk_V_9_reg_431;
    sc_signal< sc_lv<4> > q_chunk_V_10_reg_436;
    sc_signal< sc_lv<4> > q_chunk_V_11_reg_441;
    sc_signal< sc_lv<4> > q_chunk_V_12_reg_446;
    sc_signal< sc_lv<4> > q_chunk_V_13_reg_451;
    sc_signal< sc_lv<4> > q_chunk_V_14_reg_456;
    sc_signal< sc_logic > grp_lut_div3_chunk_fu_98_ap_start;
    ...
    sc_signal< sc_logic > grp_lut_div3_chunk_fu_98_ap_start_reg;
    ...
    void thread_grp_lut_div3_chunk_fu_98_ap_start();
