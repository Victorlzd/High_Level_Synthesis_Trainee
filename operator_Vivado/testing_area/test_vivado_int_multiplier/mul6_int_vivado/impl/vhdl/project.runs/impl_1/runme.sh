...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/test_vivado_int_multiplier/mul6_int_vivado/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul6.tcl -notrace
