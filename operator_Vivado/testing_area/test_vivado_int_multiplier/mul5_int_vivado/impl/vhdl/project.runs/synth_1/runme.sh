...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/test_vivado_int_multiplier/mul5_int_vivado/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul5.tcl
