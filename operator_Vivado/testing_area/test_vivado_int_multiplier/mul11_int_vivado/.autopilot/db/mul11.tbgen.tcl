set C_TypeInfoList {{ 
"mul11" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"a": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName mul11
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul11_mul_32s_5nsbkb_U1", "Parent" : "0"}]}
