...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/testing_area/test_vivado_int_multiplier/mul4_int_vivado/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul4.tcl -notrace
