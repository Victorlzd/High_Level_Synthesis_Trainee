...
if {[file isfile int_13_div3.autotvin.dat]} {
	file delete -force int_13_div3.autotvin.dat
}

if {[file isfile int_13_div3.autotvout.dat]} {
	file delete -force int_13_div3.autotvout.dat
}
