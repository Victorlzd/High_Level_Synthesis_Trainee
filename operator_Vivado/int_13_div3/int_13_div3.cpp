...
/* int_32_div7 implements a division by 7 of the integer 32 bits in, optimized for Vivado HLS */
ap_uint<32> int_32_div7(ap_uint<32> in);
...
/* int_32_div13 implements a division by 13 of the integer 32 bits in, optimized for Vivado HLS */
ap_uint<32> int_32_div13(ap_uint<32> in);
/* operator_int_32_div273 implements a division by 273 of the integer 32 bits in, optimized for Vivado HLS */
...
ap_uint<32> int_32_div7(ap_uint<32> in) {
	...
	q.range(31, 30) = q_chunk.range(1, 0);
	for(i = 9; i >= 0; i = i - 1) {
		#pragma HLS unroll
		{
...
ap_uint<32> operator_int_32_div273(ap_uint<32> in) {
	return int_32_div13(int_32_div7(int_32_div3(in)));
}
...
float float_div3(float in) {
	...
	if (exp != 255) {
		...
		xf = xf << shift;
		xf = xf + 136;
		new_mant = operator_int_32_div273(xf);
	}
