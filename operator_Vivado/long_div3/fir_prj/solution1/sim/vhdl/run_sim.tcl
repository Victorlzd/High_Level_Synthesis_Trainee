...
if {[file isfile long_div3.autotvin.dat]} {
	file delete -force long_div3.autotvin.dat
}

if {[file isfile long_div3.autotvout.dat]} {
	file delete -force long_div3.autotvout.dat
}
