...
architecture behav of lut_div3_chunk is 
    ...
    signal p_Result_8_fu_36_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal agg_result_V_i2_fu_178_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i_fu_44_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i1_fu_722_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i8_fu_588_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i6_fu_454_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i4_fu_320_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_1_fu_856_p5 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_Result_s_fu_312_p3 : STD_LOGIC_VECTOR (1 downto 0);

    component long_div3_mux_646bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    long_div3_mux_646bkb_U1 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i_fu_44_p66);

    long_div3_mux_646bkb_U2 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i2_fu_178_p66);

    long_div3_mux_646bkb_U3 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i4_fu_320_p66);

    long_div3_mux_646bkb_U4 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i6_fu_454_p66);

    long_div3_mux_646bkb_U5 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i8_fu_588_p66);

    long_div3_mux_646bkb_U6 : component long_div3_mux_646bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_36_p3,
        dout => agg_result_V_i1_fu_722_p66);




    ap_ready <= ap_const_logic_1;
    ap_return_0 <= p_Result_1_fu_856_p5;
    ap_return_1 <= p_Result_s_fu_312_p3;
    p_Result_1_fu_856_p5 <= (((agg_result_V_i1_fu_722_p66 & agg_result_V_i8_fu_588_p66) & agg_result_V_i6_fu_454_p66) & agg_result_V_i4_fu_320_p66);
    p_Result_8_fu_36_p3 <= (r_in_V & d_V);
    p_Result_s_fu_312_p3 <= (agg_result_V_i2_fu_178_p66 & agg_result_V_i_fu_44_p66);
end behav;
