...
#define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.operator_int_div29.autotvin_in_r.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.operator_int_div29.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.operator_int_div29.autotvout_ap_return.dat"
...
extern int operator_int_div29 (
int in);

int AESL_WRAP_operator_int_div29 (
int in)
{
			...
			// bitslice(31, 0)
			{
				// celement: in(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// regulate_c_name       : in
						// input_type_conversion : in
						if (&(in) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> in_tmp_mem;
							in_tmp_mem = in;
							in_r_tvin_wrapc_buffer.range(31, 0) = in_tmp_mem.range(31, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		int AESL_return = operator_int_div29(in);
