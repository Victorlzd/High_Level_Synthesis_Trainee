...
architecture behav of lut_div29_chunk is 
    ...
    signal agg_result_V_i8_fu_576_p66 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_i6_fu_442_p66 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Result_s_fu_710_p6 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_Result_7_fu_724_p66 : STD_LOGIC_VECTOR (0 downto 0);

    component operator_int_div2bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    operator_int_div2bkb_U1 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div2bkb_U2 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div2bkb_U3 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    operator_int_div2bkb_U4 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_32_p3,
        dout => agg_result_V_i6_fu_442_p66);

    operator_int_div2bkb_U5 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_32_p3,
        dout => agg_result_V_i8_fu_576_p66);

    operator_int_div2bkb_U6 : component operator_int_div2bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din63 => ap_const_lv1_0,
        din64 => p_Result_8_fu_32_p3,
        dout => p_Result_7_fu_724_p66);




    ap_ready <= ap_const_logic_1;
    ap_return_0 <= p_Result_s_fu_710_p6;
    ap_return_1 <= p_Result_7_fu_724_p66;
    p_Result_8_fu_32_p3 <= (r_in_V & d_V);
    p_Result_s_fu_710_p6 <= ((((agg_result_V_i8_fu_576_p66 & agg_result_V_i6_fu_442_p66) & agg_result_V_i4_fu_308_p66) & agg_result_V_i2_fu_174_p66) & agg_result_V_i_fu_40_p66);
end behav;
