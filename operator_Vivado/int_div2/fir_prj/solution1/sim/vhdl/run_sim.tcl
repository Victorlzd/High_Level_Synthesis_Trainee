...
if {[file isfile int_div2.autotvin.dat]} {
	file delete -force int_div2.autotvin.dat
}

if {[file isfile int_div2.autotvout.dat]} {
	file delete -force int_div2.autotvout.dat
}
