...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/int_div2/fir_prj/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log int_div2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source int_div2.tcl -notrace
