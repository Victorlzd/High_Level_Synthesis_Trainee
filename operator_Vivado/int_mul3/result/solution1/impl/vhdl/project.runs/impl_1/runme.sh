...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/int_mul3/result/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log int_32_mul3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source int_32_mul3.tcl -notrace
