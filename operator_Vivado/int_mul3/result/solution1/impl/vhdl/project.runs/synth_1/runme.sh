...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/int_mul3/result/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_32_mul3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_32_mul3.tcl
