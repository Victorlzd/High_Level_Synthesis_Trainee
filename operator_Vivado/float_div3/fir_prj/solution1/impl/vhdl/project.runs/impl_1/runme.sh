...
HD_PWD='/home/duazel/Documents/stage3IF/High_Level_Synthesis_Trainee/operator_Vivado/float_div3/fir_prj/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log float_div3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source float_div3.tcl -notrace
