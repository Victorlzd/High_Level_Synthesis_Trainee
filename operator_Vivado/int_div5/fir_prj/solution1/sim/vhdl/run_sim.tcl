...
if {[file isfile int_div5.autotvin.dat]} {
	file delete -force int_div5.autotvin.dat
}

if {[file isfile int_div5.autotvout.dat]} {
	file delete -force int_div5.autotvout.dat
}
