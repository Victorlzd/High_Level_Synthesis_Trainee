...
architecture behav of lut_div5_chunk is 
    ...
    signal p_Result_8_fu_32_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component int_div5_mux_646_bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    int_div5_mux_646_bkb_U1 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    port map (
        ...
        din64 => p_Result_8_fu_32_p3,
        dout => agg_result_V_i_fu_40_p66);

    int_div5_mux_646_bkb_U2 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    int_div5_mux_646_bkb_U3 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    int_div5_mux_646_bkb_U4 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    int_div5_mux_646_bkb_U5 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    int_div5_mux_646_bkb_U6 : component int_div5_mux_646_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    p_Result_8_fu_32_p3 <= (r_in_V & d_V);
